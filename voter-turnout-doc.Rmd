...
hist_df %>% 
  ...
  ggplot() +
    ...
    geom_point(color = "Yellow") + geom_line(color = "Yellow") +
...
race_df %>% 
  ...
  geom_point() + geom_line() +
  facet_wrap(~Age) +
  ggtitle("Voters of Different Age Groups and Race") +
  ylab("Voting Percentage") +
  xlab("Years (1964-2018)") +
  labs(color = "Races") +
  scale_color_viridis(discrete = TRUE, labels = race_names) +
...
race_df %>% 
  ...
  ggtitle("Voting Percents of Voters by Age and Race") +
  xlab("Races") +
